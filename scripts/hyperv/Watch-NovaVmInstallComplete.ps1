...
if ($unattend) {
    ...
    # L'invite de demarrage est passee a Send-NovaVmBootKey.ps1, lance par
    # Start-NovaVm.ps1 avant meme la mise sous tension : la faire ici la
    # manquait, le temps d'arriver jusqu'a elle suffisait a la rater.
