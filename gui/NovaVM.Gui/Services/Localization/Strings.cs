...
internal static class Strings
{
    public static readonly Dictionary<string, string> French = new()
    {
        ...
        ["VmList_Usb_VmOff_Title"] = "Demarrez la VM pour lui confier un peripherique",
        ["VmList_Usb_VmOff_Why"] = "Ce n'est pas l'hote qui pousse le peripherique : c'est la VM qui vient le chercher, par le reseau, avec son propre client USB/IP. Une machine eteinte n'a ni systeme ni adresse pour le faire. Bonne nouvelle : il suffit de le faire UNE FOIS. La VM memorise le peripherique et le reprend toute seule a chacun de ses demarrages suivants.",
    ...
    public static readonly Dictionary<string, string> English = new()
    {
        ...
        ["VmList_Usb_VmOff_Title"] = "Start the VM to hand it a device",
        ["VmList_Usb_VmOff_Why"] = "The host does not push the device across: the VM comes and fetches it over the network, with its own USB/IP client. A machine that is off has neither an OS nor an address to do that. The good news: you only need to do it ONCE. The VM remembers the device and picks it up on its own at every later start.",
